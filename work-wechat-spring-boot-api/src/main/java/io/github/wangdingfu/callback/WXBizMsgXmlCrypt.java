 ...
 * 官方下载地址：http://commons.apache.org/proper/commons-codec/download_codec.cgi
 */
package io.github.wangdingfu.callback;
...
public class WXBizMsgXmlCrypt {
     ...
     */
    public WXBizMsgXmlCrypt(String token, String encodingAesKey, String receiveid) throws AesException {
    ...
    String encrypt(String randomStr, String text) throws AesException {
        ...
        try {
            ...
            e.printStackTrace();
            throw new AesException(AesException.ENCRYPTAES_ERROR);
        }
    }
